...
# Check for Profile Updates (on Github)
function Update-Profile {
    ...
    try {
        $url = "https://raw.githubusercontent.com/samo-L-B/settings/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
